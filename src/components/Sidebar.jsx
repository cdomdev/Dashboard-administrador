...
export const Sidebar = ({ isAuthenticated }) => {
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 font-">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <a href="/" className="flex justify-center items-center">
                <span className="text-2xl -mb-2 pl-2 md:mb-0 md:text-2xl font-extrabold text-[#22365c] uppercase">
                Dashboard
                </span>
              </a>
            </div>
      ...
      <aside
        id="logo-sidebar"
        className="fixed lg:block font- top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200   sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar">
